...
const messageBodyForCancel = "<h1>Event Canceled</h1><p>Blah Blah</p>"
const messageBodyForUpdate = "<h1>Event Update</h1><p>Blah Blah</p>"
// could have other sample message bodies.

// we can add to these
let messageTemplates = {
	"invite": {
		messageSubject: "You've been invited to an event via MyShindig!",
		messageBodyHTML: messageBodyForInvite,
		messageBodyText: "New event. add to this later"
	},
	"cancel": {
		messageSubject: "Your MyShindig event canceled",
		messageBodyHTML: messageBodyForCancel,
		messageBodyText: "Canceled event. add to this later"
	},
	"update": {
		messageSubject: "Update to MyShindig event",
		messageBodyHTML: messageBodyForUpdate,
